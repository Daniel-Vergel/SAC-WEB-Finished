...
const PlaceHolder = () => {
    return (
        <div className='grid grid-flow-col items-center gap-x-7'>
            <><IconImpresora /> Imprimir Listado</>
        </div>
    )
}
...
export const InputReports = () => {
  ...
  return (
    <div className='font-roboto text-16 text-gray8'>
        <Select
            defaultValue={ timeOptions[0]}
            options={ [timeOptions[1],timeOptions[2] ] }
        />
