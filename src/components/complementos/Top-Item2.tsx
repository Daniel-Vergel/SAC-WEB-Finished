        ...
        <div className=" flex">
          ...
          <div className=" ml-10 mt-16">
            <div className=" h-40 w-40 border-2 border-orange4 bg-orange4 rounded-full">
              <p className=" flex justify-center mt-4 font-trebuchet text-20 text-orange1">
                1
              </p>
            </div>
          </div>
          ...
          <div className=" flex w-full ml-8 mt-16   ">
            ...
            <div className=" ml-8 ">
              <p className=" font-trebuchet font-bold text-14 text-gray1">
                Anna Pacheco
              </p>
              <p className=" font-verdana text-10 mt-5  text-gray2 ">
                Consultor SWIT
              </p>
            </div>
          </div>
            ...
            <div className=" flex">
              <div className="grid grid-flow-col items-center w-40 h-20 border-2 border-green1 bg-green2 rounded-3">
                <div className=" ml-1 -mt-2 grid grid-flow-col items-center ">
                  ...
                  <div className="text-green1 text-10 mr-3 mt-2">2%</div>
                </div>
              </div>
