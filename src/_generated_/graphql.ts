...
export type ActivityView = {
  ...
  activityCode?: Maybe<Scalars['Float']['output']>;
  answerStartDate?: Maybe<Scalars['DateTime']['output']>;
  assignedDate?: Maybe<Scalars['DateTime']['output']>;
  assignedDateHour?: Maybe<Scalars['DateTime']['output']>;
  assignedDateTime?: Maybe<Scalars['DateTime']['output']>;
  assignedHour?: Maybe<Scalars['String']['output']>;
  bitCode?: Maybe<Scalars['Float']['output']>;
  bitRadChannel?: Maybe<Scalars['String']['output']>;
  bitStatus?: Maybe<Scalars['Boolean']['output']>;
  bitTicket?: Maybe<Scalars['String']['output']>;
  caseCode?: Maybe<Scalars['String']['output']>;
  caseDescription?: Maybe<Scalars['String']['output']>;
  clientCode?: Maybe<Scalars['Float']['output']>;
  clientName?: Maybe<Scalars['String']['output']>;
  createdDate?: Maybe<Scalars['DateTime']['output']>;
  createdIp?: Maybe<Scalars['String']['output']>;
  createdUserId?: Maybe<Scalars['Float']['output']>;
  createdUserNickname?: Maybe<Scalars['String']['output']>;
  description?: Maybe<Scalars['String']['output']>;
  executorCode?: Maybe<Scalars['Float']['output']>;
  executorFullName?: Maybe<Scalars['String']['output']>;
  executorName?: Maybe<Scalars['String']['output']>;
  executorSurname?: Maybe<Scalars['String']['output']>;
  historyCreatedDate?: Maybe<Scalars['DateTime']['output']>;
  hoursRemaining?: Maybe<Scalars['Float']['output']>;
  id: Scalars['Int']['output'];
  isAssembly?: Maybe<Scalars['Boolean']['output']>;
  isDaily?: Maybe<Scalars['Boolean']['output']>;
  isEditable?: Maybe<Scalars['Boolean']['output']>;
  isPartial?: Maybe<Scalars['Boolean']['output']>;
  isReassigned?: Maybe<Scalars['Boolean']['output']>;
  isRedmine?: Maybe<Scalars['Boolean']['output']>;
  isSecure?: Maybe<Scalars['Boolean']['output']>;
  isState?: Maybe<Scalars['Boolean']['output']>;
  itemCode?: Maybe<Scalars['String']['output']>;
  itemDescription?: Maybe<Scalars['String']['output']>;
  itemParentCode?: Maybe<Scalars['Float']['output']>;
  itemParentDescription?: Maybe<Scalars['Float']['output']>;
  lastExecutorDate?: Maybe<Scalars['DateTime']['output']>;
  maxAccumulatedHours?: Maybe<Scalars['Float']['output']>;
  personEmail?: Maybe<Scalars['String']['output']>;
  personUsername?: Maybe<Scalars['String']['output']>;
  productCode?: Maybe<Scalars['Float']['output']>;
  productName?: Maybe<Scalars['String']['output']>;
  publicDescription?: Maybe<Scalars['String']['output']>;
  receivedDate?: Maybe<Scalars['DateTime']['output']>;
  remainingPercentage?: Maybe<Scalars['Float']['output']>;
  remainingTime?: Maybe<Scalars['String']['output']>;
  secureOrder?: Maybe<Scalars['Float']['output']>;
  serialAnnex?: Maybe<Scalars['Float']['output']>;
  solutionType?: Maybe<Scalars['String']['output']>;
  state?: Maybe<Scalars['String']['output']>;
  statusDate?: Maybe<Scalars['DateTime']['output']>;
};

export type ActivityViewWhere = {
  _and?: InputMaybe<Array<ActivityViewWhere>>;
  _or?: InputMaybe<Array<ActivityViewWhere>>;
  bitTicket?: InputMaybe<StringFilter>;
...
export type QueryGetCurrentActivitiesArgs = {
  pagination?: InputMaybe<Pagination>;
  where?: InputMaybe<ActivityViewWhere>;
};
